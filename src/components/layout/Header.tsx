    ...
    <header className="sticky top-0 z-50 w-full border-b border-slate-200 bg-white/80 backdrop-blur-md">
      <div className="flex h-20 w-full items-center justify-center sm:justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex-1 hidden sm:flex justify-end items-center gap-4">
          ...
          <Link
            to="/resultados"
            className="inline-flex items-center rounded-lg border border-brand-200 bg-brand-50 px-4 py-2 text-sm font-semibold text-brand-700 transition-colors hover:bg-brand-100">
            Mis resultados
          </Link>
          <Link
            to="/hub"
